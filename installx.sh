...
Install() {
	if [[ ${release} == "centos" ]]; then
		...
		wget https://proxy.freecdn.workers.dev/?url=https%3A%2F%2Fgithub.com%2Fdaycat%2FwhmcsPortForward%2Fraw%2Fmain%2F%25E8%258A%2582%25E7%2582%25B9%25E5%2590%258E%25E7%25AB%25AF%2Fslave.zip
		unzip slave.zip && cp -r * /usr/local/PortForward/slave/
